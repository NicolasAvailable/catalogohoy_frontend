...
|---|---|---|---|---|---|---|
| **gratis** | $0 | 1 (visible en catálogo público) | 1 | 0 | 1 | **10** |
| **basico** | $9.99 | hasta 100 | 1 | 1 | 3 | **15** |
...
- Asignación mensual por plan: **gratis 10 · básico 15 · avanzado 500** (2026-06-30: gratis
  5→10; básico 150→200→**15** al pasar a Nano Banana, un modelo más caro; histórico: 100/400 →
  150/500 el 2026-06-21). El allowance del owner = **mayor plan** entre sus catálogos.
