  ...
  light: {
    root: {
      ...
      contrast: {
        ...
        hoverBackground: 'var(--color-white-600)',
        hoverBorderColor: 'var(--color-grey-100)',
        activeBackground: 'var(--color-white-700)',
        color: 'var(--color-grey-300)',
        hoverColor: 'var(--color-grey-300)',
        activeColor: 'var(--color-grey-300)',
...
export const button = { root, colorScheme };
